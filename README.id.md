...
Install CLI dulu (panduan muncul otomatis kalau belum terinstall)

Buka /cli di dashboard

Klik Configure for Loka

Pilih endpoint, model, atau combo

Selesai — CLI sekarang ngarah ke Loka
...
🤝 Kontribusi
Pull request, issue, dan feedback sangat diterima. Buka issue di GitHub atau fork repo-nya.
