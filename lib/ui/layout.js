...
'      <div class="brand-sub">AI Router</div>',
'    </div>',
'  </div>',
'  <nav>' + nav + '</nav>',
'  <div class="sidebar-foot">',
'    <button class="icon-btn" onclick="toggleTheme()" title="Toggle theme"><span id="themeIcon"></span></button>',
'    <button class="icon-btn" onclick="toggleSidebar()" title="Hide sidebar"><span></span></button>',
'  </div>',
'</aside>',
'<main>',
...
'  var h = document.body.classList.toggle("sidebar-hidden");',
'  try { localStorage.setItem("loka-sidebar", h ? "hidden" : "shown"); } catch(e) {}',
'}',
'',
...
'',
'    // Fresh input tiap dialog dibuka',
'    wrap.innerHTML = "";',
'    var input = null;',
'    if (opts.input) {',
'      wrap.style.display = "";',
...
'    };',
'',
'    var onOk = function(){ done(input ? input.value : true); };',
'    var onCancel = function(){ done(input ? null : false); };',
'    var onOverlay = function(e){ if (e.target === ov) done(input ? null : false); };',
...
'    if (s === "hidden" || (s === null && m)) document.body.classList.add("sidebar-hidden");',
'  } catch(e) {}',
'})();',
'',
...
'  var notified = {};',
'  function poll() {',
'    fetch("/api/tunnel/notifications", {',
'      headers: { "Authorization": "Bearer " + LOKA_KEY }',
'    })',
