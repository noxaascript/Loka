...
aside .brand{
  padding:0 1.15rem 1.1rem;margin-bottom:.6rem;
...
aside .brand-text{min-width:0;overflow:hidden;line-height:1.2}
aside .brand-name{
...
aside .brand-sub{font-size:.66rem;color:var(--text-3);letter-spacing:.05em;text-transform:uppercase;font-weight:600}
...
/* MAIN */
main{
  margin-left:var(--sb);padding:2rem 2.5rem 3rem;
...
.menu-toggle{
  ...
  backdrop-filter:var(--blur);-webkit-backdrop-filter:var(--blur);
  border:1px solid var(--glass-border);
  color:var(--text-1);width:42px;height:42px;border-radius:12px;
